# GP Aviation
GP Aviation is the homepage for the hypothetical helicopter company based in Sweden focused on selling experience trips, such as sightseeing tours around Stockholm, short learning sessions with instructors or luxurious transfer trips.
...
The navigation bar is collapsed behind a bars icon, when clicked it expands and links leading to different pages appear.
When viewed on bigger screens, the bars icon becomes invisible and the links are arranged in a row on the header bar.
### Main Page
...
This is my Portfolio Project 1 as a part of the Full Stack Software Developer at [Code Institute](https://codeinstitute.net/).
David Eriksson 2023